...
<body>
    ...
    <div id="main" class="container">
        ...
        <form action="cadastrar_jogador" method="post">
            <!-- area de campos do form -->
            <div class="row">
            	<div class="form-group col-md-6">
	                    <label for="nome">Nome</label>
	                    <input type="text" class="form-control" name="nomeJogador" id="nome" required maxlength="100" placeholder="nome do jogador">
	            </div>
	            <div class="form-group col-md-6">
	                    <label for="dataNascimento">Data de Nascimento</label>
	                    <input type="text" class="form-control" name="nascimento_jogador" id="dataNascimento" placeholder="formato dd/mm/yyyy">
	            </div>
            </div>
